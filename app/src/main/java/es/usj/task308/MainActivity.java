...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set filter to only when download is complete and register
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.startDownload:
                ...
                //Restrict the types of networks over which this download may be proceed.
                ...
                request.setDescription("Android Data download usingDownloadManager.");
    ...
    private BroadcastReceiver downloadReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(downloadReference == referenceId){
                ...
                Button cancelDownload = (Button)
                        findViewById(R.id.cancelDownload);
                cancelDownload.setEnabled(false);
                ...
                try {
                    ...
                    TextView showCountries = (TextView)
                            findViewById(R.id.countryData);
